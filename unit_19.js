...
document.querySelector('.div-13').onmousedown = () => {
    let a = document.querySelector('.div-13');
    a.classList.add('active');
};
...
function t18() {
    ...
    document.querySelector('.div-18').innerHTML = w + 'px';
}
...
function t19() {
    let c = document.querySelector('.div-19').classList;
    document.querySelector('.out-19').innerHTML = c;
